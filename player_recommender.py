...
class PlayerRecommender:
    ...
    def load_recommendations(self):
        ...
        while (
            ...
            try:
                ...
                self.recommendations = {
                    name: info
                    for name, info in all_summoners.items()
                    if name not in self.summoner.already_recommended
                    and self.matches_criteria(info)
                    and name != self.summoner.name
                }
    ...
    def recommend(self):
        if self.recommendations:
            ...
            self.summoner.already_recommended[recommended_summoner_name] = (
                recommended_summoner_info
            )
